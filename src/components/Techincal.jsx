function Techincal() {
  return (
    <div className="my-15" id="skills">
      <h1 className="text-7xl text-white font-extrabold text-center">
        Tech Stack
      </h1>
      <p className="text-white text-xl my-6 max-w-2xl m-auto text-center">
        A comprehensive overview of the languages, frameworks, and tools I
        utilize to engineer scalable, high-performance web applications.
      </p>
